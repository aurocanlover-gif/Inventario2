...
# --- CONFIGURACIÓN DE FIREBASE (PRUEBA DE FUERZA BRUTA) ---
import firebase_admin
from firebase_admin import credentials, firestore

# Este es el diccionario directo, sin leer archivos ni variables de entorno
firebase_config = {
  "type": "service_account",
  "project_id": "inventario-render",
  "private_key_id": "c0aaaf9704b1280f8f254818dcb8595d70da7466",
  "private_key": "-----BEGIN PRIVATE KEY-----\\nGcnekVNUtD4O0v1Z7QqdvHOQ\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@inventario-render.iam.gserviceaccount.com",
  "client_id": "118064624684863522924",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40inventario-render.iam.gserviceaccount.com",
...
try:
    ...
    db = firestore.client()
    print("🚀 CONEXIÓN FORZADA EXITOSA")
except Exception as e:
    print(f"❌ ERROR SIGUE PERSISTIENDO: {e}")
    db = None
